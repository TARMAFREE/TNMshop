<template>
  <div>
    ...
    <div v-if="!cart.items.length" class="card">
      <div class="card-body">
        ...
        <div class="hr"></div>
        <RouterLink class="btn primary" to="/shop">Continue shopping</RouterLink>
      </div>
    </div>
  ...
  @change="cart.setQty(it.product.id, it.quantity)"
/>
        ...
        <div class="row" style="flex-wrap:wrap; gap:10px;">
          <RouterLink class="btn" to="/shop">Continue shopping</RouterLink>
